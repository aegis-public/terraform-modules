...
locals {
  inferred_env_vars = {
    ...
    AEGIS_TOPIC_MESSAGE_IDS        = try(google_pubsub_topic.gmail_message_ids[0].name, null)
    AEGIS_SUBSCRIPTION_MESSAGE_IDS = try(google_pubsub_subscription.gmail_message_ids[0].name, null)
  }
